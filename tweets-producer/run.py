...
if __name__ == '__main__':
    ...
    consumer_key, consumer_secret, access_token, access_token_secret = os.getenv('CONSUMER_KEY'), os.getenv(
        'CONSUMER_SECRET'), os.getenv('ACCESS_TOKEN'), os.getenv('ACCESS_TOKEN_SECRET')
    stream = TweetsListener(consumer_key, consumer_secret,
